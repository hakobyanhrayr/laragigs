...
<?php $component->withAttributes([]); ?>
    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.card','data' => ['class' => 'p-10 rounded max-w-lg mx-auto mt-24']]); ?>
...
<?php $component->withAttributes(['class' => 'p-10 rounded max-w-lg mx-auto mt-24']); ?>
        ...
        <form action="<?php echo e(route('post.update',$listing->id)); ?>"
              method="POST" style="background: #718096;padding: 20px"
...
$message = $__bag->first($__errorArgs[0]); ?>
                <p class="text-red-500 text-xs mt-3"><?php echo e($message); ?></p>
                <?php unset($message);
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\xampp7.4\htdocs\laragigs\resources\views/listings/edit.blade.php ENDPATH**/ ?>